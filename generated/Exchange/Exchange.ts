...
export class Exchange__getOrderInfoResultOrderInfoStruct extends ethereum.Tuple {
  get orderStatus(): i32 {
    return this[0].toI32();
  }
...
export class Exchange__getOrderInfoInputOrderStruct extends ethereum.Tuple {
  get makerAddress(): Address {
...
export class Exchange__isValidOrderSignatureInputOrderStruct extends ethereum.Tuple {
  get makerAddress(): Address {
    return this[0].toAddress();
  }
...
export class Exchange__isValidTransactionSignatureInputTransactionStruct extends ethereum.Tuple {
  get salt(): BigInt {
...
export class Exchange extends ethereum.SmartContract {
  ...
  getOrderInfo(
    order: Exchange__getOrderInfoInputOrderStruct
  ): Exchange__getOrderInfoResultOrderInfoStruct {
    let result = super.call(
      "getOrderInfo",
    ...
    return result[0].toTuple() as Exchange__getOrderInfoResultOrderInfoStruct;
  }

  try_getOrderInfo(
    order: Exchange__getOrderInfoInputOrderStruct
  ): ethereum.CallResult<Exchange__getOrderInfoResultOrderInfoStruct> {
    let result = super.tryCall(
      "getOrderInfo",
      "getOrderInfo((address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256,bytes,bytes,bytes,bytes)):((uint8,bytes32,uint256))",
      [ethereum.Value.fromTuple(order)]
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Exchange__getOrderInfoResultOrderInfoStruct
    );
  }
  ...
  isValidOrderSignature(
    order: Exchange__isValidOrderSignatureInputOrderStruct,
    signature: Bytes
  ): boolean {
    let result = super.call(
      "isValidOrderSignature",
  ...
  isValidTransactionSignature(
    transaction: Exchange__isValidTransactionSignatureInputTransactionStruct,
    signature: Bytes
  ): boolean {
    let result = super.call(
      "isValidTransactionSignature",
